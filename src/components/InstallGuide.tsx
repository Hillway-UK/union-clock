            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-3 bg-[#EAEAEA] rounded-lg border border-[#939393]">
                  <div className="bg-[#702D30] text-white rounded-full w-8 h-8 flex items-center justify-center font-heading font-bold">1</div>
                  <div>
                    <p className="font-heading font-bold text-[#111111]">Open in Safari</p>
                    <p className="text-sm font-body text-[#111111]">Make sure you're viewing this page in Safari browser</p>
                  </div>
                </div>
